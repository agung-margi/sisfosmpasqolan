...
const Pcards = (props) => {
  ...
  <div className="w-full self-center px-4 lg:w-1/2">
    <h1 className="block font-bold text-dark text-4xl mt- mb-5 lg:text-5xl">{props.title} </h1>
    <h2 className="font-medium text-slate-700 text-justify text-lg mb-5 lg:text-2xl">{props.content}</h2>
  </div>
  )
}
...
const ImgCards = (props) => {
  return(
    <div className=" my-20 mx-auto w-full self-end lg:w-1/2">
